...
module Verifier {
    export class FOLRulebookFactory implements IRulebookFactory {
        ...
        private rules: { [id: string] : IRule } =
        {
            ...
            "copy" : <Verifier.Rule> {
                Name : "COPY",
                Type : "derived",
                SimpleVerifier : new Justifier({StepRefs:["num"]},
            ...
            "mt" : <Verifier.Rule> {
                Name : "MT",
                Type : "derived",
                SimpleVerifier : new Justifier({StepRefs:["num","num"]},
                    function(proof, step, part, steps):any {
            ...
            "pbc" : <Verifier.Rule> {
                Name : "PBC",
                Type : "derived",
                SimpleVerifier : new Justifier(
                { HasPart : false, StepRefs : ["range"], Substitution : false },
                function(proof, step, part, steps):any {
            ...
            "contra" : <Verifier.Rule>{
                    Name : "Contradiction",
                    Type : "normal",
                    ElimVerifier : new Justifier(
                        { HasPart : false, StepRefs : ["num"], Substitution : false },
                        function(proof, step, part, steps):any {
                            var refStep = proof.steps[steps[0]].getSentence();
            ...
            "->" : <Verifier.Rule> {
                ...
                ElimVerifier : new Justifier(
                    { HasPart : false, StepRefs : ["num", "num"], Substitution : false },
                    function(proof, step, part, steps):any {
