var v = require("../folproof-verifier.js");

exports["preprocess - Sets first/last statements"] = function(test) {
...
exports["verifyFromAST - Syntax errors result in invalid proofs"] = function(test) {
...
exports["verifyFromAST - Proofs can be valid"] = function(test) {
